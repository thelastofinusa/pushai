...
const demos = [
  ...
  },
  {
    ...
    command: "pai list",
    output: [
      "┌ ● PushAI Explorer → Browse available providers & models",
      "│",
      "│ OpenAI → openai",
      "│ → gpt-4.1-mini — paid • recommended",
      "│ → gpt-4.1 — paid • best quality",
      "│ → gpt-4.1-nano — paid • lightweight",
      "│",
      "│ Anthropic Claude → anthropic",
      "│",
      "│ → claude-3-5-haiku-latest — fast • cheap • recommended",
  ...
  },
  {
    ...
    command: "pai commit",
    output: [
      "┌ ● PushAI Commit → Anthropic Claude session initialized",
      "│",
